...
<section class="container py-lg-5">
  <!--User table-->
    <h1 class="slideInDown animated">Aquí están los registros diarios de los usuarios</h1></br>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Filtro de log / Exportar a Excel</button>
    </div>
    <!-- Log filter -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filtre su registro de usuario:</h3>
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      <div class="panel-heading">Filtrar por fecha:</div>
                      <div class="panel-body">
                      <label for="Start-Date"><b>Seleccione a partir de esta fecha:</b></label>
                      <input type="date" name="date_sel_start" id="date_sel_start">
                      <label for="End -Date"><b>Hasta esta Fecha:</b></label>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <input type="radio" id="radio-one" name="time_sel" class="time_sel" value="Time_in" checked/>
                          <label for="radio-one" style="white-space: nowrap;">Time-in</label>
                        </div>
                      </div>
                      <div class="panel-body">
                        <label for="Start-Time"><b>Seleccione a partir de esta fecha:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Hasta esta Fecha:</b></label>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Filtrar por Usuario:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filtrar por dispositivos:</b></label>
