...
<div class="header">
	<div class="logo" style="text-align: center;">
		<img src="https://i.postimg.cc/7Z4ys0hZ/logo-explora-1.png" alt="Logo de Parque Explora" style="max-width: 150px; height: auto;">
	</div>
</div>
	...
	if (isset($_GET['success'])) {
		if ($_GET['success'] == "updated") {
			echo '	<script type="text/javascript">
			 			setTimeout(function () {
			                $(".up_info2").fadeIn(200);
			                $(".up_info2").text("Su cuenta ha sido actualizada");
              			}, 500);
              			setTimeout(function () {
	...
	if (isset($_GET['login'])) {
	    if ($_GET['login'] == "success") {
	      echo '<script type="text/javascript">
	              ...
	              setTimeout(function () {
	                $(".up_info2").fadeIn(200);
	                $(".up_info2").text("Inicio de sesión correcto");
	              }, 500);
...
<div class="topnav" id="myTopnav">
    ...
    <a href="ManageUsers.php">Gestionar Usuarios</a>
    <a href="UsersLog.php">Log de Accesos</a>
